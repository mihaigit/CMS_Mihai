...
<form method="post" action="edit_posts.php?edit_form=<?php echo $edit_id; ?>" enctype="multipart/form-data">
	...
	<table style="font-size:12px; font-family:Tahoma;" width="600" bgcolor="#EFF5FB" align="center" border="0" style= "background:#FAFAFA;">
		
		<tr>
			<td align="center" bgcolor="#E6E6E6" colspan="6"><h1>Edit The Post Here</h1></td>
		</tr>
